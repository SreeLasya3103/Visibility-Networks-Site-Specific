"""
plot_improvement_vs_samples.py  (Step 4)
...
Usage:
    cd vis_networks
    python plot_improvement_vs_samples.py
    python plot_improvement_vs_samples.py --save
"""
...
GLOBAL_CSV   = os.path.join(BASE, "site_eval_visnet/site_specific_validation_epoch0.csv")
FINETUNE_CSV = os.path.join(BASE, "finetune_results_with_prediction/persite_results.csv")
